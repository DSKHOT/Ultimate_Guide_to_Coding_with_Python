...
def start():
    print("Let's play game of Poker Dice.")
    while game():
        pass
    scores()
...
def throws():
    ...
    while True:
        ...
        try:
            ...
            pass
        print("Oops! Input is Invalid. Please enter 1, 2, 3, 4 or 5.")
        ...
        if rerolls == 0:
            ...
            print("Enter the number of dice reroll:")
            iterations = 0
...
def roll(roll_number):
    numbers = range(1, 7)
    dice = list(range(int(roll_number)))

    iterations = 0
    while iterations < int(roll_number):
        iterations += 1
